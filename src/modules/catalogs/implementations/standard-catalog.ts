import type { Metadata } from "../../../core/types/handler-error.types";
import type { CatalogEntry } from "../../../core/types/error-catalog.types";
import { ErrorCatalog } from "../base-catalog";
